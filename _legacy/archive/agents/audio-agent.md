...
- **Per-location musical character**:
  - Office: stressed, slightly wonky, off-meter accents, mid-tempo.
  - Court: stately, minor key, mock-serious, slow.
  - Café Paragraf: warm, jazz-inflected, unhurried.
  - Archive: sparse, ambient, tape-hiss simulated by filtered noise.
  - Penthouse: lounge / cocktail jazz parody.
