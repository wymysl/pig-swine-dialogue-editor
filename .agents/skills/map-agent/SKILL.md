---
name: map-agent
description: Use when designing or editing tile maps, room generators, decoration placement, doors, exits, or overworld layout for the Pig & Swine RPG. Activates on changes to src/data/maps.js or src/data/decorations.js. Owns spatial design; produces ASCII layouts and door tables for review.
---
...
- `design_bible.md` §5.5 (location tone table) and §6 (visual style canon)
...
- **Distinctness**: rooms must feel different at a glance. Match the location-tone table in `design_bible.md` §5.5.
