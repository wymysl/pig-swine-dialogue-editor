---
name: graphics-agent
description: Use when generating or editing portraits, sprites, tile rendering, particle effects, parallax layers, or UI rendering for the Pig & Swine RPG. Activates on changes to src/renderer.js, src/characters.js, or src/effects.js. All visuals are procedural canvas drawing — no PNG/JPG/SVG imports.
---
...
- `design_bible.md` §6 (visual style canon) and §3 (per-character visual identity)
