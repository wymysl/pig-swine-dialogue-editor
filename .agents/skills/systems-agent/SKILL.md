---
name: systems-agent
description: Use when implementing or editing core game systems for the Pig & Swine RPG — game state, save/load, room transitions, evidence board, contradiction spotting, team assembly, quest state machines, or any cross-cutting system. Activates on changes to src/state.js or files under src/systems/. Sole writer of state.js; requires save migration for any state shape change.
---
...
- Quest flag spec from the chapter outline if working on a chapter sprint
